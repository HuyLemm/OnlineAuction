    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, cron_service_1.CronService.closeExpiredAuctions()];
            case 1:
                count = _a.sent();
            ...
            case 2:
                err_1 = _a.sent();
                console.error("❌ [CRON] Auction cron failed", err_1);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, cron_service_1.CronService.downgradeExpiredSellers()];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
                err_2 = _a.sent();
                console.error("❌ [CRON] Seller expiry cron failed", err_2);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
