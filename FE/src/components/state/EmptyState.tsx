...
const emptyConfigs: Record<string, EmptyConfig> = {
  "no-items": {
    ...
    message:
      "There are no auction items at the moment. Check back soon for new listings!",
  ...
  "no-bids": {
    ...
    title: "No Bids Yet",
    message:
      "Be the first to place a bid on this item. Don't miss this opportunity!",
  ...
  "no-orders": {
    ...
    title: "No Orders Yet",
    message:
      "You haven't completed any purchases. Start bidding to win amazing items!",
  ...
  "no-messages": {
    ...
    title: "No Messages",
    message:
      "Your inbox is empty. Start a conversation with sellers or buyers.",
    color: "text-cyan-500",
  },
  "no-listings": {
    icon: FileText,
    ...
    message:
      "You don't have any active listings. Create your first auction to start selling!",
  ...
  "no-activity": {
    ...
    message:
      "There's no recent activity to display. Start bidding or selling to see your activity here.",
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 max-w-md">
        <h3 className="text-foreground">{title || config.title}</h3>
